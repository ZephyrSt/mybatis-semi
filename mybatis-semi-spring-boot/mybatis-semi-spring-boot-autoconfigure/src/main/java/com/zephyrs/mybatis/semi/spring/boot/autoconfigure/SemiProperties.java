...
import com.zephyrs.mybatis.semi.config.SensitiveConfig;
import com.zephyrs.mybatis.semi.exceptions.MappedProcessorException;
import com.zephyrs.mybatis.semi.injects.DefaultInjectProcessor;
import com.zephyrs.mybatis.semi.injects.InjectProcessor;
import com.zephyrs.mybatis.semi.plugins.keygenerate.KeyGenerateInterceptor;
import com.zephyrs.mybatis.semi.plugins.sensitive.SensitiveDecryptInterceptor;
import com.zephyrs.mybatis.semi.plugins.sensitive.SensitiveEncryptInterceptor;
...
public class SemiProperties {
    ...
    public static class GlobalConfig extends com.zephyrs.mybatis.semi.config.GlobalConfig {
        ...
        public void applyTo(SemiMybatisConfiguration target){
            ...
            com.zephyrs.mybatis.semi.config.GlobalConfig config = new com.zephyrs.mybatis.semi.config.GlobalConfig();
