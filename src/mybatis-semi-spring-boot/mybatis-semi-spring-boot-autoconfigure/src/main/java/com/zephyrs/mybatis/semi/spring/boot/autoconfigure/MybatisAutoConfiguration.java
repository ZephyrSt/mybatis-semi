...
@EnableConfigurationProperties({MybatisProperties.class, SemiProperties.class})
...
public class MybatisAutoConfiguration implements InitializingBean {
    ...
    private final SemiProperties semiProperties;
    ...
    public MybatisAutoConfiguration(MybatisProperties properties,
        ...
        this.semiProperties = semiProperties;
    ...
    private void applyConfiguration(SqlSessionFactoryBean factory) {
        ...
        SemiMybatisConfiguration configuration = null;
        if (coreConfiguration != null || !StringUtils.hasText(this.properties.getConfigLocation())) {
            configuration = new SemiMybatisConfiguration();
        }
        ...
        if(this.semiProperties != null) {
            this.semiProperties.applyTo(configuration);
        }
